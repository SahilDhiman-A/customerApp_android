...
import com.spectra.consumer.Adapters.MyTopUpAdapter;
...
public class MyCosumnedTopupFragment extends Fragment {
    ...
    private void setInitView(Bundle bundle){
        if(bundle!=null) {
            ...
            if(topUpRC!=null && topUpRC.size()>0) {
                ...
                myTopUpAdapter = new MyTopUpAdapter(getContext(), topUpRC, false);
                view_topups.setAdapter(myTopUpAdapter);
            }
        }
    }
}
