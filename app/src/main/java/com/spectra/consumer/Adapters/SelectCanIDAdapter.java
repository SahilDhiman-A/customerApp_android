...
public class SelectCanIDAdapter extends RecyclerView.Adapter<SelectCanIDAdapter.SelectCanViewHolder> {
    ...
    public SelectCanIDAdapter(Context context, List<LoginMobileResponse> userDataList, CanIdSelected canIdSelected){
    ...
    public SelectCanViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        ...
        return new SelectCanIDAdapter.SelectCanViewHolder(LayoutInflater.from(context).inflate(R.layout.select_can_item,null));
    }
