package com.spectra.consumer.customView;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private List<FaqInfo> mediaObjects = new ArrayList<>();
...
//       videoSurfaceView.setResizeMode(AspectRatioFrameLayout.RESIZE_MODE_FIT);
        ...
        videoSurfaceView.setShowMultiWindowTimeBar(true);
...
//        });
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        FaqChildAdapter.FaqChildViewHolder holder = (FaqChildAdapter.FaqChildViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
    ...
    public void playVideo(FaqChildAdapter.FaqChildViewHolder holder, int position) {

        if (videoPlayer == null || viewHolderParent == null) {
            init(context);
        }
        videoSurfaceView.setVisibility(INVISIBLE);
        removeVideoView(videoSurfaceView);
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(
                context, Util.getUserAgent(context, "RecyclerView VideoPlayer"));
        String mediaUrl = mediaObjects.get(position).getVideo_url();
...
//            toggleVolume();
    ...
    public void setMediaObjects(List<FaqInfo> mediaObjects) {
